...
/**
 * @brief Represents an MV (Open Party List) election, where candidates
 * are sorted by popularity within the party
 */
class MVSystem : public ElectionSystem {
 public:
  /**
   * @brief Constructs an MVSystem instance.
   *
   ...
   */
  explicit MVSystem(std::string filename = "ballot.txt");
